...
export async function POST(request) {
  try {
    ...
    // Verify the person calling this is actually signed in, using their token
    ...
    // Verify they're admin or manager before letting them send invites
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 480px;">
            <h2 style="color: #3D1250;">You've been invited to ACE</h2>
            <p>Someone on your team invited you to join their project management workspace.</p>
            <p><a href="${siteUrl}/login" style="background:#6B2D82; color:white; padding:12px 24px; border-radius:8px; text-decoration:none; display:inline-block;">Sign up for ACE</a></p>
            <p style="color:#888; font-size:13px;">Or copy this link: ${siteUrl}/login</p>
          </div>
        `,
      }),
    });
